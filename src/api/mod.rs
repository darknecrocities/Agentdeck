...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    Router::new()
        ...
        .route("/api/system/screenshot/stop", post(handlers::system::stop_screen_handler))
        ...
        .route("/ws/screen", get(handlers::ws::ws_screen_stream_handler))
        .route("/api/ws/screen", get(handlers::ws::ws_screen_stream_handler))
