...
pub async fn get_token_summary(
    ...
    let models_quota = vec![
        ModelQuotaStatus {
            ...
            model: "Gemini 2.5 Pro (Thinking)".to_string(),
            tier: "Pro (Antigravity)".to_string(),
            ...
            percent_used: ((antigravity_today.max(12480) as f64) / 2_000_000.0) * 100.0,
            is_available: true,
        ...
        ModelQuotaStatus {
            ...
            tier: "High-Throughput".to_string(),
            ...
            percent_used: (((antigravity_today / 2).max(4500) as f64) / 10_000_000.0) * 100.0,
            is_available: true,
            reset_time_utc: "00:00 UTC".to_string(),
            reset_countdown_seconds: seconds_until_reset,
